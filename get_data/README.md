...
- !CAUTION! on Visual Genome! The current python script downloads a few extra empty images (2316942 and 2417331). You should run "visualgenome_find_corrupted.py" and then remove manually the extra images. This can be done from terminal, for example via:

rm /path/to/folder/visual_genome/images/train2017/2316942.jpg
rm /path/to/folder/visual_genome/images/train2017/2417331.jpg
