#!/bin/bash
#SBATCH --export=NONE
#SBATCH --job-name=single_tok_llm_coco
#SBATCH --output=logs/single_tok_llm_coco_%A_%a.out
#SBATCH --error=logs/single_tok_llm_coco_%A_%a.err
...
TARGET_ROOT="/home/kirilb/orcd/scratch/PRH_data/single_token_${DATASET}_llm"
HF_CACHE_DIR="/home/kirilb/orcd/pool/huggingface_models_cache"
PYTHON_SCRIPT="filter_single_token_words_llm.py"
CAPTION_KEY="caption"
