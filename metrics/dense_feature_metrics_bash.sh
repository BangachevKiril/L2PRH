...
INPUT_PATH="/home/kirilb/orcd/pool/PRH_data/embedded_${DATASET}"
OUT_DIR_BASE="/home/kirilb/orcd/pool/PRH_data/metrics_embedded_${DATASET}"

USE_NORMALIZED=1 # 0: raw embeddings, 1: centered embeddings
