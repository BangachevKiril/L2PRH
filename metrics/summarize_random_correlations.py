...
DEFAULT_BASE_ROOT = "/home/kirilb/orcd/pool/PRH_data"
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=(
            "Base directory containing embedded_<name>/ and topk_sae_<name>/ folders. "
            f"Default: {DEFAULT_BASE_ROOT}"
        ),
    )
